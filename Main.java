package budget;
import budget.sorting.Sorter;
import budget.sorting.SortingAlgorithmAll;
import budget.sorting.SortingAlgorithmByType;
import budget.sorting.SortingAlgorithmCertainType;
    ...
    private boolean sortMenuOptions(Scanner scanner, String read) {
        ...
        switch (Integer.parseInt(read)) {
            case 1:
                ...
                sorter = new Sorter(new SortingAlgorithmAll(map));
                break;
            case 2:
                sorter = new Sorter(new SortingAlgorithmByType(map));
                break;
            case 3:
                sorter = new Sorter(new SortingAlgorithmCertainType(map, scanner));
                break;
            case 4:
                return false;
            default:
